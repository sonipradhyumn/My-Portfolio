        ...
        <div ref={ref} className={' back-img h-screen  bg-cover bg-center  '}>
            <div className='layer h-full w-full'>
                <div className='absolute h-full w-full text-white  grid place-items-center   px-9 '>
                    ...
                    <div className=" hidden absolute lg:flex justify-end items-center right-20 h-52 w-36 box cursor-pointer ">
                        <span className='px-2 mr-4 pb-0 hide border-4 border-t-red-800 border-b-red-800 border-l-0 border-r-0 font-serif font-semibold '>My Resume</span>
                        <div className="arrow"></div>
                    </div>
                    <div className=" absolute bottom-8   flex justify-center  items-end  h-32 w-36 box  " onClick={()=>{window.scrollTo(0, ref.current?.clientHeight)}}>
